...
const NotificationItem = ({ notification, onMarkAsRead }: { notification: NotificationAttributes; onMarkAsRead: (id: string) => void }) => {
    ...
    return (
        <motion.div
            ...
            className={`
                bg-card border border-border rounded-lg p-3 sm:p-4 transition-all duration-200 cursor-pointer
                ${!notification.is_read ? 'border-l-4 border-l-primary shadow-sm' : 'hover:border-border hover:shadow-sm'}
                                    `}
            onClick={handleClick}
        >
            <div className="flex items-start gap-3 sm:gap-4">
                ...
                <div className="flex-shrink-0 relative">
                    ...
                    {!notification.is_read && (
                        <div className="absolute -top-1 -right-1 w-3 h-3 bg-primary border-2 border-card rounded-full"></div>
                    )}
                </div>
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2">
                        <div className="flex-1 min-w-0">
                            ...
                            <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2 mb-1">
                                <p className={`text-sm ${!notification.is_read ? 'font-semibold text-foreground' : 'text-foreground/90'}`}>
                                    {notification.title}
                                </p>
                                <Badge
                                    variant="secondary"
    ...
    return (
        <div className="min-h-screen bg-background">
            <div className="max-w-4xl mx-auto p-4 sm:p-6">
                ...
                >
                    <div className="flex items-center gap-4 sm:gap-6 border-b border-border overflow-x-auto scrollbar-hide">
